...
foreach my $entry ( @data )
{
    ...
    print "\t\t\"Id\" : \"$entry->[1]\",\n";
    print "\t\t\"RegisterAddress\" : \"$entry->[0]\",\n";
    print "\t\t\"ArmPin\" : \"$entry->[2]\",\n";
    print "\t\t\"DefaultMode\" : 0,\n";
    print "\t\t\"Mode00Signal\" : \"$entry->[3]\",\n";
    print "\t\t\"Mode01Signal\" : \"$entry->[4]\",\n";
    print "\t\t\"Mode02Signal\" : \"$entry->[5]\",\n";
    print "\t\t\"Mode03Signal\" : \"$entry->[6]\",\n";
    print "\t\t\"Mode04Signal\" : \"$entry->[7]\",\n";
    print "\t\t\"Mode05Signal\" : \"$entry->[8]\",\n";
    print "\t\t\"Mode06Signal\" : \"$entry->[9]\",\n";
    print "\t\t\"Mode07Signal\" : \"$entry->[10]\",\n";
    print "\t\t\"Mode08Signal\" : \"$entry->[11]\",\n";
    print "\t\t\"Mode09Signal\" : \"$entry->[12]\",\n";
    print "\t\t\"Mode10Signal\" : \"$entry->[13]\",\n";
    print "\t\t\"Mode11Signal\" : \"$entry->[14]\",\n";
    print "\t\t\"Mode12Signal\" : \"$entry->[15]\",\n";
    print "\t\t\"Mode13Signal\" : \"$entry->[16]\",\n";
    print "\t\t\"Mode14Signal\" : \"$entry->[17]\",\n";
    print "\t\t\"Mode15Signal\" : \"$entry->[18]\"\n";
...
0x167C	eth mii rx d0	W2	rgmii0_rxd0	rmii0_txd0		mii0_txd0	vin2a_fld0	vin4b_fld1						pr1_mii0_txd0	pr2_pru1_gpi16	pr2_pru1_gpo16	gpio5_31	Driver off
...
0x1800	local i2c sda	C21	i2c1_sda															
0x1804	local i2c scl	C20	i2c1_scl															
